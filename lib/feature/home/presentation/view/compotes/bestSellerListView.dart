        ...
        builder: (context, state) {
          return SliverList(
            delegate: SliverChildBuilderDelegate(
                  ...
                  return Padding(
                    ...
                    child: GestureDetector(
                      ...
                      child: Best_Seller(
                          ...
                          authorName:
                              book.volumeInfo?.authors?.first.toString() ??
                                  "N/A",
                          // price: book.saleInfo!.listPrice?.amount.toString()??"N/A",
                          rate: book.volumeInfo?.averageRating.toString() ??
                              "N/A",
                          viewing: book.volumeInfo?.averageRating.toString() ??
                              "N/A"),
                    ),
                  );
              ...
              childCount: state is FetchNewestBooksSuccess
